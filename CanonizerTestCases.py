...
testCases = {
    ...
    'TC_UPDATE_NEWS_WITH_BLANK_LINK': [Critical, 'On Edit News page, When user does not put Link , user must see '
                                                 'Error Message'],
    'TC_LOAD_EDIT_NEWS_PAGE': [Critical, 'User must see edit news form'],
    'TC_CLICK_LOG_OUT_PAGE_BUTTON':[Critical,' User must see dashboars as a guest user'],
    'TC_LOAD_CAMP_STATEMENT_PAGE':[Critical, 'User must see camp statement page'],
    'TC_ADD_CAMP_STATEMENT_PAGE_WITH_ASTERISK': [Critical, 'User should able to add statement'],
    'TC_ADD_CAMP_STATEMENT_WITHOUT_MANDATORY_FIELD': [Critical, 'User should not able to add statement'],
    'TC_ADD_CAMP_STATEMENT_WITH_TRAILING_SPACES': [Critical, 'User should not able to add statement'],
    'TC_ADD_CAMP_STATEMENT_WITH_BLANK_DATA': [Critical, 'User should not able to add statement'],
    'TC_LOAD_EDIT_CAMP_STATEMENT': [Critical, 'User must see edit camp form'],
    'TC_UPDATE_CAMP_STATEMENT_WITH_MANDATORY_FIELD': [Critical, 'User should able to update camp'],
    'TC_EDIT_CAMP_STATEMENT_WITH_BLANK_DATA': [Critical, 'User should not able to update camp'],
    'TC_COMPARE_CAMP_STATEMENT': [Critical, 'User must see camp statement camparision page'],
    'TC_ADD_CAMP_STATEMENT': [Critical, 'User should able to add statement'],
    'TC_EDIT_CAMP_STATEMENT': [Critical, 'User should able to edit statement'],
    'TC_LOAD_CAMP_MANAGE_EDIT_PAGE': [Critical, 'User must see edit camp form'],
    'TC_UPDATE_CAMP_WITH_DUPLICATE_CAMP_NAME': [Critical, 'User should not able to duplicate camp'],
    'TC_VERIFY_CANCEL_BUTTON_FUNCTIONALITY_ON_CAMP_UPDATE_PAGE': [Critical, 'User should able to cancel update camp'],
    'TC_VERIFY_PREVIEW_BUTTON_FUNCTIONALITY_ON_CAMP_UPDATE_PAGE': [Critical, 'User must see update camp preview'],
    'TC_VERIFY_CAMP_NAME_ON_PREVIEW_MODAL': [Critical, 'User must see camp name at camp preview'],
    'TC_SUBMITTER_NICK_NAME_ON_PREVIEW_MODAL': [Critical, 'User must see nickname at camp preview'],
    'TC_VERIFY_COMPARE_CAMPS_BUTTON_FUNCTIONALITY': [Critical, 'User must see compare camp page after clicking compare button'],
    'TC_VERIFY_CAMPS_NAME_ON_CAMP_HISTORY_COMPARISON_PAGE': [Critical, 'User must see camp name at compare camp page'],
    'TC_UPLOAD_FILE_WITHOUT_ADMIN_LOGIN': [Critical, 'User must see login page'],
    'TC_UPLOAD_FILE_WITH_ADMIN_LOGIN': [Critical, 'User should able to upload file'],
    'TC_UPLOAD_MORE_THAN_5MB_FILE_WITH_USER_LOGIN': [Critical, 'User must see large file warning'],
    'TC_UPLOAD_FILE_WITH_INVALID_FILE_NAME_FORMAT': [Critical, 'User must see invalid file name warning'],
    'TC_CLICK_UPLOAD_BUTTON': [Critical, 'User must see upload form'],
    'TC_UNKNOWN_TOPIC': [Critical, 'User must see topic not found'],
    'TC_ASP_URL_REDIRECTION': [Critical, 'User must redirected on new address'],
    'TC_VIDEO_URL': [Critical, 'User must see videos list'],
    'TC_SUPPORT_LIST_ASP_URL_REDIRECTION': [Critical, 'User must redirected to support list address'],
    'TC_THREAD_ASP_URL_REDIRECTION': [Critical, 'User must redirected to new thread address'],
    'TC_FORUM_ASP_URL_REDIRECTION': [Critical, 'User must redirected to new forum address'],
    'TC_TOPIC_ASP_URL_REDIRECTION': [Critical, 'User must redirected to new topic address'],
    'TC_MANAGE_ASP_URL_REDIRECTION': [Critical, 'User must redirected to new manage address'],
    'TC_STATEMENT_ASP_URL_REDIRECTION': [Critical, 'User must redirected to new statement address'],
    'TC_SITEMAP_URL': [Critical, 'User must redirected to new manage address'],
    'TC_UPDATE_NEWS': [Critical, 'User must see update news page'],
    'TC_SUBMIT_CAMP_UPDATE': [Critical, 'User must see update camp'],
    'TC_FOOTER_BROWSE': [Critical, 'User must see browse page'],
    'TC_FOOTER_CREATE_NEW_TOPIC': [Critical, 'User must see create new topic form'],
    'TC_FOOTER_UPLOAD': [Critical, 'User must see upload form'],
    'TC_FOOTER_SITEMAP': [Critical, 'User must see sitemap page'],
    'TC_FOOTER_HELP': [Critical, 'User must see help page'],
    'TC_FOOTER_WHITE_PAPER': [Critical, 'User must see white paper'],
    'TC_FOOTER_BLOG': [Critical, 'User must see blog page'],
    'TC_FOOTER_JOBS': [Critical, 'User must see job page'],
