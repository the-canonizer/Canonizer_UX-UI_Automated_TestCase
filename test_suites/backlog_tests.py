...
class BacklogTests:
    """Placeholders for coverage that still needs page objects or fixtures.

    Each is marked no_browser: they assert nothing yet, so starting a browser
    for them would cost seven launches per run for no benefit.
    """
